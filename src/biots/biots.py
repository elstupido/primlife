...
def addVectorsB2(xxx_todo_changeme, xxx_todo_changeme1):
...
#     b2length = math.hypot(v3.x,v3.y)    
    ...
    (angle1, length1) = xxx_todo_changeme
    (angle2, length2) = xxx_todo_changeme1
...
def addVectors(xxx_todo_changeme2, xxx_todo_changeme3):
    (angle1, length1) = xxx_todo_changeme2
    (angle2, length2) = xxx_todo_changeme3
...
class Biot:
    ...
    def __init__(self,x,y,father=None):
        ...
        for arm in self.arms:
            ...
            for nodeid, armSegment in sorted(arm.idBiot.items()):
...
#             return (0,0)
    ...
    def drawVectorBiot(self,x,y):
        ...
        for nodeid, armSegment in self.idBiot.items():
